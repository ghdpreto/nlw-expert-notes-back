...
@Operation(tags = "Nota", summary = "Criar nota.", description = "Criar uma nova nota vinculada ao usuário.")
@ApiResponses(value = {
                @ApiResponse(responseCode = "201", description = "Nota crida", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NotaResponseDTO.class))),
...
public @interface CriarNotaSwagger {
}
